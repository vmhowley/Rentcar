      ...
      <div className="relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">Discover the experience of <a className="text-red-600 underline rent--car--text " href="">Rent </a>A Luxury <a className="text-red-600 underline rent--car--text " href="">Car </a> with Us</h2>
